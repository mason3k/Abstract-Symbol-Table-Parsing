...
class SymbolTable {
   ...
   private Scope top;
   public ArrayList<ParmInfo> parmList;

   SymbolTable() {top = new Scope();}

   public void openScope() {
      top = new Scope(top); 
      parmList = new ArrayList<ParmInfo>();}
   ...
   public void addParmToSt(ASTNode.Types type, ASTNode.Kinds kind) {
		ParmInfo parm = new ParmInfo(type,kind);
		parmList.add(parm);
	}
